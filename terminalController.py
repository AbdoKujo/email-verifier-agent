...
def run_terminal(terminal_id: int, csv_path: str, output_queue: List, run_in_background: bool = False, max_retries: int = 3) -> None:
    """
    ...
    try:
        ...
        with open(batch_file, 'w') as f:
            ...
            f.write(f'python main.py < "{files_dir}\\terminal_input_{terminal_id}.txt" >> "{output_file}" 2>&1\n')
